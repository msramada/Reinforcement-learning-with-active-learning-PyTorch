    ...
    def train(self, epochs):
        ...
        for j in range(epochs):
            ...
            for j in reversed(range(horizon_length)):
                ...
                Vals_next[j,:] = rewards[indices,0] + self.gamma * (self.Value.forward(next_states[indices,:])).squeeze().detach()
            ...
            #Actor_loss = -torch.min(surrogate1, surrogate2).mean() - self.beta * self.entropy
